...
- **Rigorous Evaluation:** Covering seven balanced emotion categories. Note: the dataset now contains seven missing-modality subsets with uneven sample counts across subsets, while the seven emotion categories remain balanced.
